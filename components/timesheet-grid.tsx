        ...
        <Table>
            <TableHeader className="bg-muted/40 sticky top-0 z-10 backdrop-blur-sm">
                <TableRow className="hover:bg-transparent border-b border-border/60">
                    <TableHead className="w-[80px] h-9 pl-4 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                        {labels.date}
                    </TableHead>
                    <TableHead className="w-[140px] h-9 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                        {labels.day}
                    </TableHead>
                    <TableHead className="h-9 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                        {labels.project}
                    </TableHead>
                    <TableHead className="w-[80px] h-9 pr-4 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground text-center">
                        {labels.hours}
                    </TableHead>
                </TableRow>
            </TableHeader>
                            ...
                            <TableCell className="py-0 h-9">
                                <div className="flex items-center gap-2">
                                    ...
                                    {day.isHoliday && (
                                        <Badge
                                            variant="outline"
                                            className="text-[9px] font-semibold text-primary border-primary/20 bg-primary/5 px-1.5 py-0 h-4 leading-none rounded-sm"
                                        >
