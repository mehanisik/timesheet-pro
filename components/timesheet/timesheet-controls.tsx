    ...
    return (
        <div className="flex flex-col gap-2 p-3 bg-muted/20 rounded-xl border border-border/50">
            ...
            <div className="grid grid-cols-12 gap-2">
                {/* Row 1: Config & Branding */}
                <div className="col-span-12 lg:col-span-1 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.year}</Label>
                    <Controller
                        control={control}
                        name="year"
                        render={({ field }) => (
                ...
                <div className="col-span-6 lg:col-span-2 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.month}</Label>
                    <Controller
                        control={control}
                        name="month"
                        render={({ field }) => (
                                ...
                                <SelectContent>
                                    {Array.from({ length: 12 }, (_, i) => i + 1).map((m) => (
                                        <SelectItem key={m} value={String(m)}>
                                            {new Date(2000, m - 1).toLocaleString(lang === 'PL' ? 'pl-PL' : 'en-US', { month: 'long' })}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                            </Select>
                ...
                <div className="col-span-6 lg:col-span-1 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.lang}</Label>
                    <Controller
                        control={control}
                        name="lang"
                        render={({ field }) => (
                ...
                <div className="col-span-6 lg:col-span-2 space-y-0.5">
                    {/* Reusing Label style for consistency */}
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">Region</Label>
                    <Controller
                        control={control}
                        name="holidayBank"
                        render={({ field }) => (
                ...
                <div className="col-span-6 lg:col-span-2 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.documentRef}</Label>
                    <Controller
                        control={control}
                        name="customRef"
                        render={({ field }) => (
                ...
                <div className="col-span-12 lg:col-span-4 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.branding}</Label>
                ...
                {/* Row 2: Identity & Defaults */}
                <div className="col-span-12 lg:col-span-3 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.client}</Label>
                    <Controller
                        control={control}
                        name="client"
                        render={({ field }) => (
                ...
                <div className="col-span-12 lg:col-span-3 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.person}</Label>
                    <Controller
                        control={control}
                        name="person"
                        render={({ field }) => (
                ...
                <div className="col-span-8 lg:col-span-4 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.defaultProj}</Label>
                    <Controller
                        control={control}
                        name="defaultProj"
                        render={({ field }) => (
                ...
                <div className="col-span-4 lg:col-span-2 space-y-0.5">
                    <Label className="text-[10px] uppercase text-muted-foreground font-semibold tracking-wider">{t.defaultHours}</Label>
                    <Controller
                        control={control}
                        name="defaultHours"
                        render={({ field }) => (
